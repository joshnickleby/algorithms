...
public class TicTacToe {
    ...
    static private Function<String, String> CHECK_GRID = s -> s.equals("xxx") ? "x" : s.equals("ooo") ? "o" : "";

    static private Function<String, String> TOP_ROW    = s -> s.substring(0, 3);
    static private Function<String, String> MIDDLE_ROW = s -> s.substring(3, 6);
    static private Function<String, String> BOTTOM_ROW = s -> s.substring(6, 9);

    static private Function<String, String> LEFT_COLUMN   = s -> makeColumn(s, 0);
    static private Function<String, String> MIDDLE_COLUMN = s -> makeColumn(s, 1);
    static private Function<String, String> RIGHT_COLUMN  = s -> makeColumn(s, 2);

    static private Function<String, String> TOP_LEFT_TO_BOTTOM_RIGHT = s -> transform(s, 0, 4);
    static private Function<String, String> TOP_RIGHT_TO_BOTTOM_LEFT = s -> transform(s, 2, 2);

    static private List<Function<String, String>> FUNCTIONS = Arrays.asList(
